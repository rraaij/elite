 ...
 */
export function splitUint16(value) {
 ...
 */
export function joinUint16(lo, hi) {
 ...
 */
export function adc8(a, b, carryIn = 0) {
	const a8 = toUint8(a);
	const b8 = toUint8(b);
 ...
 */
export function sbc8(a, b, carryIn = 1) {
	const a8 = toUint8(a);
	const b8 = toUint8(b);
	const carry = carryIn === true || carryIn === 1 ? 1 : 0;
 ...
 */
export function rol8(value, carryIn = 0) {
 ...
 */
export function adc16(a, b, carryIn = 0) {
