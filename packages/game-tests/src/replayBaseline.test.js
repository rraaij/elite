 ...
 */
const REPLAY_CHECKPOINT_TICKS = [60, 120, 180, 240, 300, 360, 420, 480, 540, 600];
/**
 * Replay keyframes.
 ...
 */
const EXPECTED_CHECKPOINT_DIGESTS = [
...
function createNeutralControls() {
	return {
		rollAxis: 0,
		pitchAxis: 0,
		throttleAxis: 0,
...
function runReplayRange(options) {
	...
	const checkpointSet = new Set(REPLAY_CHECKPOINT_TICKS);
 ...
 */
function runScriptedReplay(captureRestoreTick) {
