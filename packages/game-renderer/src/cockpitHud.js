 ...
 */
function buildScannerRect(width, dashboardRect) {
 ...
 */
function buildScannerContacts(snapshot, scannerRect) {
	const contacts = [];
 ...
 */
function buildCompass(snapshot, dashboardRect) {
 ...
 */
function buildIndicators(snapshot) {
	return [
		{
			key: "dock",
			label: "DOCK",
 ...
 */
export function createCockpitHudModel(snapshot, viewport) {
