 ...
 */
function unitFloatFromUint32(input) {
 ...
 */
function computeStarCount(viewport) {
 ...
 */
function buildStarSample(config, viewport, starIndex) {
 ...
 */
function buildPlanetDisc(config, viewport) {
 ...
 */
function buildSunDisc(config, viewport) {
	const minDimension = Math.min(viewport.width, viewport.height);
 ...
 */
export function buildCelestialScene(config) {
